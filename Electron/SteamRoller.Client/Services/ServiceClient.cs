...
namespace SteamRoller.API.Client
{
    ...
    public partial class PlayerClient 
    {
        ...
        public async System.Threading.Tasks.Task<string> Player_UploadLibraryAsync(string userId, SteamLibrary library, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/Player/UploadLibrary?");
            if (userId != null)
            {
    ...
    public partial class SteamLibrary 
    {
        ...
        [Newtonsoft.Json.JsonProperty("gameMetadata", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<string> GameMetadata { get; set; }
    ...
    public partial class Game 
    {
        ...
        [Newtonsoft.Json.JsonProperty("stateFlags", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
